...
const App = () => {
  ...
  return (
    <div>
 {!location.pathname.includes('dashboard')   && <Navbar hundeltoken={hundeltoken} token={token} />}
      <Routes>
        ...
        <Route path='/dashboard/addProduct' element={<AddProduct token={token} hundeltoken={hundeltoken} />}  />
        <Route path='/dashboard/updateProduct/:id' element={<UpdateProduct token={token} hundeltoken={hundeltoken} />}  />
