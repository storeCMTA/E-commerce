  ...
  return (
    <div>
      {location.pathname !== "/dashboard" && (
        <Navbar hundeltoken={hundeltoken} token={token} />
      )}
      <Routes>
        <Route
          path="/"
          element={<Home products={products} hundeltoken={hundeltoken} />}
        />
      ...
      {token?(<Route
          path="/dashboard"
          element={<Dashboard token={token} hundeltoken={hundeltoken} />}
        />):<Route  element={<Err/>} />}
